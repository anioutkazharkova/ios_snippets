...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        messenger=Messenger(dataProvider: DataProvider(apiClient: ApiClient(downloader: RestClientFactory.instance.createRestClient(false)), cacheProvider: CacheProvider()))
